...
public class Order {
    ...
    public OrderCardDetails getOrderCardDetails() { return orderCardDetails; }

    public void setOrderCardDetails(OrderCardDetails orderCardDetails) { this.orderCardDetails = orderCardDetails; }
